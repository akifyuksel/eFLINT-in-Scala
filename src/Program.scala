...
//case class ErrorVal(e: Error) extends Output
//case class ExecutedTransition(t: TransInfo) extends Output
//case class Violation(v: Violation) extends Output
//case class QueryRes(q: QueryRes) extends Output
//case class InstQueryRes(iqrs: [Tagged]) extends Output
